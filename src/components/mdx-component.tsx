...
const components = {
  h1: ({ className, ...props }: ComponentsProps) => (
    <h1
      className={cn(
        "mt-2 scroll-m-20 text-4xl font-bold text-cyan-500 tracking-tight",
        className
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }: ComponentsProps) => (
    <h2
      className={cn(
        "mt-10 scroll-m-20 border-b pb-1 text-3xl font-semibold text-cyan-500 tracking-tight first:mt-0",
        className
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }: ComponentsProps) => (
    <h3
      className={cn(
        "mt-8 scroll-m-20 text-2xl font-semibold text-cyan-500 tracking-tight",
        className
      )}
      {...props}
    />
  ...
  h4: ({ className, ...props }: ComponentsProps) => (
    <h4
      className={cn(
        "mt-8 scroll-m-20 text-xl font-semibold text-cyan-500 tracking-tight",
        className
      )}
      {...props}
    />
  ...
  h5: ({ className, ...props }: ComponentsProps) => (
    <h5
      className={cn(
        "mt-8 scroll-m-20 text-lg font-semibold text-cyan-500 tracking-tight",
        className
      )}
      {...props}
    />
  ...
  h6: ({ className, ...props }: ComponentsProps) => (
    <h6
      className={cn(
        "mt-8 scroll-m-20 text-base font-semibold text-cyan-500 tracking-tight",
        className
      )}
      {...props}
    />
  ...
  a: ({ className, ...props }: ComponentsProps) => (
    <a
      className={cn(
        "font-medium underline text-cyan-500 underline-offset-4",
        className
      )}
      {...props}
    />
